...
"#ccc",122,13);drawMessage("The faster you are, the more points you get","#ccc",142,13);drawMessage("Race against time through five bizzy levels","#ccc",162,13);drawMessage("Created for Ludum Dare 21 - 'Escape'","#dfd",200,16);mouseDown(0)&&this.Restart();break;case LEVEL_LAST:drawMessage("right click to play again","rgb("+a+","+a+","+a+")",175,13);drawMessage("you saved uzzz, thanks!","#cf0",135);drawMessage(this.score,"yellow",200);mouseDown(2)&&this.Restart();break;default:if(drawMessage("LEVEL "+
